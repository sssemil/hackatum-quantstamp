// Pulled from https://goerli.etherscan.io/address/0xc3F639B8a6831ff50aD8113B438E2Ef873845552#code
...
// File contracts/test/PriceOracle.sol
...
contract PriceOracleTest is IPriceOracle, Ownable {
  ...
  function setVirtualPrice(address token, uint256 newPrice)
    external
    onlyOwner
    returns (bool)
  {
